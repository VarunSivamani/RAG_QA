...
def create_book_qa_system(pdf_path: str, embedding_model: str, model_name: str):
...
def main():
    parser = argparse.ArgumentParser(description="RAG QA system for books (PDF)")
    ...
    qa_system = create_book_qa_system(args.pdf_path, args.embed_model, args.model)
    chat_history = []
